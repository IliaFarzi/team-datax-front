...
export default function Sidebar({
  ...
  const dataConnectors = [
    ...
    {
      name: "Postgres",
      logo: "https://julius.ai/_next/image?url=https%3A%2F%2Fr2.julius.ai%2Fpostgres-logo.png&w=32&q=75",
    },
    {
      name: "Snowflake",
  ...
  return (
    <nav
      className="h-screen w-[265px] fixed bg-gray-50 flex flex-col "
      dir="rtl"
    >
      <div className="flex flex-col h-full overflow-hidden relative">
        ...
        <div className="flex items-center justify-between px-3 py-3">
          ...
          <button
            onClick={onToggleCollapse}
            className="rounded-full cursor-pointer text-center bg-transparent border-transparent p-1 hover:bg-gray-200 transition-colors"
          >
        ...
        {/* Main Navigation */}
        <nav
          className="flex-1 overflow-x-hidden overflow-y-auto px-3"
          aria-label="اصلی"
        >
                    ...
                    <div>
                      <div className="flex flex-col">
                        <div className="flex flex-col overflow-hidden">
                          ...
                          <button
                            onClick={() =>
                              setIsChatThreadsOpen(!isChatThreadsOpen)
                            }
                            className="flex items-center justify-between text-center bg-transparent border-transparent cursor-pointer"
                          >
                              ...
                              <div className="pr-6 relative max-h-[230px] overflow-auto">
                                ...
                                <div className="flex items-center bg-gray-50 rounded-lg gap-2 px-3 py-1 relative mb-2 mt-2">
                                  ...
                                  <input
                                    ...
                                    className="flex-1 bg-transparent border-none text-xs h-6 w-full outline-none"
                                  />
                                </div>
        ...
        <div className="flex flex-col items-center px-3 w-full">
          ...
          <button className="flex items-center rounded-lg text-gray-600 cursor-pointer text-sm font-medium gap-2 h-7 justify-start px-3 py-0.5 transition-colors hover:bg-gray-100 w-full">
            ...
            <span className="text-gray-600 text-sm font-medium text-left w-full">
              خروج
            </span>
          </button>
